...
if ((test-path -path '.\mods') -eq $false) {
    mkdir mods
    [IO.File]::WriteAllLines(($pwd).path+"\mods\jsonc-fflags.ps1",([System.Net.WebClient]::new()).downloadstring('https://raw.githubusercontent.com/ttewi/bloxstrap_teipatch/jsonc-fflags.ps1'));
    [IO.File]::WriteAllLines(($pwd).path+"\mods\ROBLOX_singletonMutex.ps1",([System.Net.WebClient]::new()).downloadstring('https://raw.githubusercontent.com/ttewi/bloxstrap_teipatch/ROBLOX_singletonMutex.ps1'));
...
## iex([System.Net.WebClient]::new()).downloadstring('https://raw.githubusercontent.com/ttewi/bloxstrap_teipatch/refs/heads/main/download-bloxstrap-patcher-nocd.ps1');
